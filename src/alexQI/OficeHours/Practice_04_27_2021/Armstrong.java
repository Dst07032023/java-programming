package alexQI.OficeHours.Practice_04_27_2021;

/**
 * [Armstrong]
 * Create a method that will accept a number and determine if that number
 * is an Armstrong number or not. Return a boolean.
 * Anumber is an Armstrong number if the single digits of the number raised
 * to the power of the number of digits is equal to the original
 *
 * Ex:
 *  153
 * Each digit: 1 5 3
