...
public class AddressList {
    public static void main(String[] args) {
        ...
        newAddress.setStreet(("7921 Jones branch dr Suit 200"));
        newAddress.setCity("McLean");
        newAddress.setState("VA");
        newAddress.setZipCode("22234");
        System.out.println(newAddress.toString());

        Address prontAndri = new Address("8501 Tyco Rd Ste 1A", "Vienna", "VA", "22213");
        System.out.println("Papa John = " + prontAndri.toString());
