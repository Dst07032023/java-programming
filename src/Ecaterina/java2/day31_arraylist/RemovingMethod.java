package Ecaterina.java2.day31_arraylist;
...
public class RemovingMethod {
    public static void main(String[] args) {
        ...
        Integer a = 0;
        nums.remove(a); //a is Integer, so it remove by element, the element it removes 0
        System.out.println(nums);

        nums.remove((Integer) 2);//casting the 2 to a Integer type, so I can remove the
//        element 2, not the index 22
        System.out.println(nums);
