...
public class BulkMethods2 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> nums = new ArrayList<>(Arrays.asList(4, 1, 1, 2, 3, 4, 5, 1,
                1,4, 14, 4, 5,123));
        ...
        ArrayList<String> list = new ArrayList<>(Arrays.asList(s.split("")));//converts the String to an ArrayList
        // where each character a different element
