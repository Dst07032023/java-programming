...
public class FrequencyMethod {
    public static void main(String[] args) {
        ...
        ArrayList<Character> letters = new ArrayList<>(Arrays.asList('a', 'e', 'e', 'a',
                'e', 't', 'p', 'i', 'o', 'o'));
        ...
        //Given a String determine many times the letter 'a' is in the String
        ...
        new ArrayList<>(Arrays.asList(s.split(""))); --> creates an ArrayList of the each
