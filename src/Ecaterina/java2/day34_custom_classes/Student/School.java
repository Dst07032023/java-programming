package Ecaterina.java2.day34_custom_classes.Student;
...
public class School {
    public static void main(String[] args) {
        ...
        /*
        in this case we created a new object of the Student
        class
        it means this object has a fresh copy of the instance
        variables, which means they will have their default values
         */
